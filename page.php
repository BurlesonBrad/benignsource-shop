...
get_header();
global $post;
$single_page_layout = esc_attr( get_post_meta($post->ID, 'benignsource_shop_sidebar_layout', true) );
...
<div class="titlebig" style="padding-bottom:10px;"><header class="entry-header">
<?php the_title('<h2 class="entry-title">', '</h2>'); ?></header><!-- .entry-header -->
<?php benignsource_breadcrumbs() ?></div></div></div>
<?php endif; ?>
<div class="inner">
...
<?php endwhile; // end of the loop.  ?></div><!-- #primary -->
<?php
if ($single_page_layout == 'both-sidebar' || $single_page_layout == 'left-sidebar'):
get_sidebar('left');
endif;?>
<?php if ($single_page_layout == 'both-sidebar'): ?></div>
<?php endif; ?>
<?php
