...
if($archive_bread){
  ...
  $bread_archive = esc_url( get_template_directory_uri().'/images/home-bg.jpg' );
}
if($breadcrumb == '1') :
?>
...
<div class="titlebig"><h1 class="entry-title ak-container"><?php woocommerce_page_title(); ?></h1>
<?php endif; ?>
<?php
            /**
...
<?php do_action('woocommerce_archive_description'); ?><?php endif; ?></div>
<?php if (is_active_sidebar('header-callto-action')): ?>
<div class="header-callto"><?php dynamic_sidebar('header-callto-action') ?></div>
<?php endif; ?>   
</div></header>
...
<div class="catproducts"><?php woocommerce_product_subcategories(); ?></div>
<div class="titleproduct"><h2>Products</h2></div>
...
*/
do_action('woocommerce_after_main_content');?></div></div>
<div id="secondary" class="widget-area secondary-left sidebar">
<?php do_action('woocommerce_sidebar'); ?></div>
