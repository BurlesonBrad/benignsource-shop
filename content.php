...
<?php the_post_thumbnail( 'benignsource-blog-big-thumbnail'); ?>
...
<?php the_author_posts_link(); ?> /  <?php comments_popup_link('No Comments', '1 Comment', '% Comments'); ?>
 / <?php the_category(','); ?></p></div><!-- .entry-meta -->
</header><!-- .entry-header -->
<div class="entry-content">
<div class="desc"><?php the_excerpt(); ?></div>
<a href="<?php the_permalink(); ?>" class="bttn read-more"><?php echo __('Read More', 'benignsource-shop'); ?></a></div><!-- .entry-content -->                       
</div></div>
</article><!-- #post-## -->     