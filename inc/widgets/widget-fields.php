...
*/
function benignsource_shop_widgets_show_widget_field($instance = '', $widget_field = '', $athm_field_value = '') {
    // shop Posts in array
    $benignsource_shop_postlist[0] = array(
        'value' => 0,
        'label' => '--choose--'
    );
    $arg = array('posts_per_page' => -1);
    $benignsource_shop_posts = get_posts($arg);
    foreach ($benignsource_shop_posts as $benignsource_shop_post) :
        $benignsource_shop_postlist[$benignsource_shop_post->ID] = array(
            'value' => $benignsource_shop_post->ID,
            'label' => $benignsource_shop_post->post_title
        );
    endforeach;

    extract($widget_field);

    switch ($benignsource_shop_widgets_field_type) {

        // Standard text field
        case 'text' :?>
<p><label for="<?php echo $instance->get_field_id($benignsource_shop_widgets_name); ?>"><?php echo $benignsource_shop_widgets_title; ?>:</label>
<input class="widefat" id="<?php echo $instance->get_field_id($benignsource_shop_widgets_name); ?>" name="<?php echo $instance->get_field_name($benignsource_shop_widgets_name); ?>" type="text" value="<?php echo esc_attr($athm_field_value) ; ?>" />
<?php if (isset($benignsource_shop_widgets_description)) { ?>
<br />
<small><?php echo $benignsource_shop_widgets_description; ?></small>
<?php } ?></p>
<?php
break;
//title    
case 'title' :?>
<p>
<label for="<?php echo $instance->get_field_id($benignsource_shop_widgets_name); ?>"><?php echo $benignsource_shop_widgets_title; ?>:</label>
<input class="widefat" id="<?php echo $instance->get_field_id($benignsource_shop_widgets_name); ?>" name="<?php echo $instance->get_field_name($benignsource_shop_widgets_name); ?>" type="text" value="<?php echo esc_attr($athm_field_value) ; ?>" />
<?php if (isset($benignsource_shop_widgets_description)) { ?>
<br /><small><?php echo $benignsource_shop_widgets_description; ?></small>
<?php } ?></p>
<?php
break;
case 'group_start' :?>
<div class="main-group" id="ap-font-awesome-list <?php echo $instance->get_field_id(($benignsource_shop_widgets_name)); ?>">
<div class="main-group-heading"><?php echo $benignsource_shop_widgets_title ; ?><span class="toogle-arrow"></span></div>
<div class="main-group-wrap">
<?php
break;
case 'group_end':?></div></div>
<?php
break;
 // Standard url field
case 'url' :?><p>
<label for="<?php echo $instance->get_field_id($benignsource_shop_widgets_name); ?>"><?php echo $benignsource_shop_widgets_title; ?>:</label>
<input class="widefat" id="<?php echo $instance->get_field_id($benignsource_shop_widgets_name); ?>" name="<?php echo $instance->get_field_name($benignsource_shop_widgets_name); ?>" type="text" value="<?php echo $athm_field_value; ?>" />
<?php if (isset($benignsource_shop_widgets_description)) { ?><br />
<small><?php echo $benignsource_shop_widgets_description; ?></small>
<?php } ?></p>
<?php
break;
...
case 'textarea' :?><p>
<label for="<?php echo $instance->get_field_id($benignsource_shop_widgets_name); ?>"><?php echo $benignsource_shop_widgets_title; ?>:</label>
<textarea class="widefat" rows="<?php echo $benignsource_shop_widgets_row; ?>" id="<?php echo $instance->get_field_id($benignsource_shop_widgets_name); ?>" name="<?php echo $instance->get_field_name($benignsource_shop_widgets_name); ?>"><?php echo $athm_field_value; ?></textarea></p>
<?php
break;
//iframe Textarea
...
case 'checkbox' :?>
<p>
<input id="<?php echo $instance->get_field_id($benignsource_shop_widgets_name); ?>" name="<?php echo $instance->get_field_name($benignsource_shop_widgets_name); ?>" type="checkbox" value="1" <?php checked('1', $athm_field_value); ?>/>
<label for="<?php echo $instance->get_field_id($benignsource_shop_widgets_name); ?>"><?php echo $benignsource_shop_widgets_title; ?></label>
<?php if (isset($benignsource_shop_widgets_description)) { ?><br />
<small><?php echo $benignsource_shop_widgets_description; ?></small>
<?php } ?></p>
...
<p>
<?php
echo $benignsource_shop_widgets_title;
echo '<br />';
foreach ($benignsource_shop_widgets_field_options as $athm_option_name => $athm_option_title) {?>
<input id="<?php echo $instance->get_field_id($athm_option_name); ?>" name="<?php echo $instance->get_field_name($benignsource_shop_widgets_name); ?>" type="radio" value="<?php echo $athm_option_name; ?>" <?php checked($athm_option_name, $athm_field_value); ?> />
...
<p>
<label for="<?php echo $instance->get_field_id($benignsource_shop_widgets_name); ?>"><?php echo $benignsource_shop_widgets_title; ?>:</label>
<select name="<?php echo $instance->get_field_name($benignsource_shop_widgets_name); ?>" id="<?php echo $instance->get_field_id($benignsource_shop_widgets_name); ?>" class="widefat">
<?php foreach ($benignsource_shop_widgets_field_options as $athm_option_name => $athm_option_title) { ?>
...
case 'number' :?>
<p>
<label for="<?php echo $instance->get_field_id($benignsource_shop_widgets_name); ?>"><?php echo $benignsource_shop_widgets_title; ?>:</label><br />
<input name="<?php echo $instance->get_field_name($benignsource_shop_widgets_name); ?>" type="number" step="4" min="4" id="<?php echo $instance->get_field_id($benignsource_shop_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" class="small-text" />
<?php if (isset($benignsource_shop_widgets_description)) { ?><br />
<small><?php echo $benignsource_shop_widgets_description; ?></small>
<?php } ?></p>
<?php
...
<label for="<?php echo $instance->get_field_id($benignsource_shop_widgets_name); ?>"><?php echo $benignsource_shop_widgets_title; ?>:</label>
<select name="<?php echo $instance->get_field_name($benignsource_shop_widgets_name); ?>" id="<?php echo $instance->get_field_id($benignsource_shop_widgets_name); ?>" class="widefat">
<?php foreach ($benignsource_shop_postlist as $benignsource_shop_single_post) { ?>
<option value="<?php echo $benignsource_shop_single_post['value']; ?>" id="<?php echo $instance->get_field_id($benignsource_shop_single_post['label']); ?>" <?php selected($benignsource_shop_single_post['value'], $athm_field_value); ?>><?php echo $benignsource_shop_single_post['label']; ?></option>
<?php } ?></select>
<?php if (isset($benignsource_shop_widgets_description)) { ?><br /><small><?php echo $benignsource_shop_widgets_description; ?></small>
<?php } ?></p><?php
break;
case 'upload' :
$output = '';
$id = $instance->get_field_id($benignsource_shop_widgets_name);
$class = '';
$int = '';
$value = $athm_field_value;
$name = $instance->get_field_name($benignsource_shop_widgets_name);
if ($value) {
                $class = ' has-file';
            }
            $output .= '<div class="sub-option section widget-upload">';
            $output .= '<label for="'.$instance->get_field_id($benignsource_shop_widgets_name).'">'.$benignsource_shop_widgets_title.'</label><br/>';
            $output .= '<input id="' . $id . '" class="upload' . $class . '" type="text" name="' . $name . '" value="' . $value . '" placeholder="' . __('No file chosen', 'benignsource-shop') . '" />' . "\n";
            if (function_exists('wp_enqueue_media')) {
                if (( $value == '')) {
                    $output .= '<input id="upload-' . $id . '" class="upload-button-wdgt button" type="button" value="' . __('Upload', 'benignsource-shop') . '" />' . "\n";
                } else {
                    $output .= '<input id="remove-' . $id . '" class="remove-file button" type="button" value="' . __('Remove', 'benignsource-shop') . '" />' . "\n";
                }
            } else {
                $output .= '<p><i>' . __('Upgrade your version of WordPress for full media support.', 'benignsource-shop') . '</i></p>';
            }
            ...
            if ($value != '') {
                ...
                if ($image) {
                    ...
                    $title = __('View File', 'benignsource-shop');
...
<input class="hidden-icon-input" name="<?php echo $instance->get_field_name($benignsource_shop_widgets_name); ?>" type="hidden" id="<?php echo $instance->get_field_id($benignsource_shop_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" />
<?php if (isset($benignsource_shop_widgets_description)) { ?>
<br />
<small><?php echo $benignsource_shop_widgets_description; ?></small>
<?php } ?></p>
...
function benignsource_shop_widgets_updated_field_value($widget_field, $new_field_value) {

    extract($widget_field);

    // Allow only integers in number fields
    if ($benignsource_shop_widgets_field_type == 'number') {
        return absint($new_field_value);

        // Allow some tags in textareas
    } elseif ($benignsource_shop_widgets_field_type == 'textarea') {
        // Check if field array specifed allowed tags
        if (!isset($benignsource_shop_widgets_allowed_tags)) {
            // If not, fallback to default tags
            $benignsource_shop_widgets_allowed_tags = '<p><strong><em><a>';
        }
        
        return strip_tags($new_field_value, $benignsource_shop_widgets_allowed_tags);

        // No allowed tags for all other fields
    } elseif ($benignsource_shop_widgets_field_type == 'iframe_textarea') {
        // Check if field array specifed allowed tags
        if (!isset($benignsource_shop_widgets_allowed_tags)) {
            // If not, fallback to default tags
            $benignsource_shop_widgets_allowed_tags = '<iframe>';
        }
    ...
    elseif ($benignsource_shop_widgets_field_type == 'url') {
        return esc_url_raw($new_field_value);
    }
    elseif ($benignsource_shop_widgets_field_type == 'title') {
